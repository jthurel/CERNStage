...
send_config_button = tk.Button(root, text="Send Config to TFA", command=lambda: send_config(jesaispas, port))
...
view_config_button = tk.Button(root, text="View Config file", command=view_config(source))
...
start_sweep_button = tk.Button(root, text="Start Sweep", command=Start_Sweep(port))
...
abort_sweep_button = tk.Button(root, text="Abort Sweep", command=Abort_Sweep(port))
